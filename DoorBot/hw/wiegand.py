...
class decoder:
   ...
   def _cb(self, gpio, level, tick):
      ...
      if level < pigpio.TIMEOUT: # falling edge trigger before timeout
         ...
         if self.in_code:
            ...
            if gpio == self.gpio_0:
               self.code_timeout = self.code_timeout | 1 # set timeout gpio 0
            else:
               self.code_timeout = self.code_timeout | 2 # set timeout gpio 1
